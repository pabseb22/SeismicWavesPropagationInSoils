...
for corte_index = 1:length(cortes)
    ...
    folder_to_test = opensees_results_folder + "\homogeneous_corte_" + string(corte) + "\simulacion";
    ...
    %         i = 1;
        ...
        % se corre simulacion
        fileGeneration_homogeneous(suelo_0, corte, y_tamano, dy)
        ...
        copyfile( tmp_folder + "\*.out", opensees_results_folder + "\homogeneous_corte_" + string(corte) + "\simulacion\homogeneo" )
        copyfile( tmp_folder + "\*.txt", opensees_results_folder + "\homogeneous_corte_" + string(corte) + "\simulacion\homogeneo" )
        ...
        message = "*** LA CARPETA " + ...
                  opensees_results_folder + "\homogeneous_corte_" + string(corte) ...
                  + " YA EXISTE ***";
        disp(message);
